...
class TestGDALUtils(TestCase):
    ...
    @patch("aws.osml.model_runner.gdal.gdal_utils.get_gdal_driver_extensions")
    @patch("aws.osml.model_runner.gdal.gdal_utils.gdal")
    def test_get_extensions_from_driver(self, mock_gdal, mock_get_drivers):
        from aws.osml.model_runner.gdal.gdal_utils import get_extensions_from_driver
    ...
    def test_get_gdal_driver_extensions(self):
        from aws.osml.model_runner.gdal.gdal_utils import get_gdal_driver_extensions
    ...
    def test_select_extension(self):
        from aws.osml.model_runner.gdal.gdal_utils import select_extension
    ...
    def test_normalize_extension(self):
        from aws.osml.model_runner.gdal.gdal_utils import normalize_extension
    ...
    def test_get_image_extension(self):
        from aws.osml.model_runner.gdal.gdal_utils import get_image_extension
