...
class TestSensorModelFactory(TestCase):
    def test_sensor_model_builder_ms_rpc00b_with_cscrna(self):
        from aws.osml.model_runner.gdal.sensor_model_factory import SensorModelFactory
        from aws.osml.model_runner.photogrammetry.composite_sensor_model import CompositeSensorModel
        from aws.osml.model_runner.photogrammetry.coordinates import GeodeticWorldCoordinate
        from aws.osml.model_runner.photogrammetry.projective_sensor_model import ProjectiveSensorModel
        from aws.osml.model_runner.photogrammetry.rpc_sensor_model import RPCSensorModel
    ...
    def test_sensor_model_builder_ms_rpc00b_with_chip(self):
        from aws.osml.model_runner.gdal.sensor_model_factory import SensorModelFactory, SensorModelTypes
        from aws.osml.model_runner.photogrammetry.chipped_image_sensor_model import ChippedImageSensorModel
        from aws.osml.model_runner.photogrammetry.coordinates import GeodeticWorldCoordinate, ImageCoordinate
        from aws.osml.model_runner.photogrammetry.rpc_sensor_model import RPCSensorModel
    ...
    def test_sensor_model_builder_rsmpca(self):
        from aws.osml.model_runner.gdal.sensor_model_factory import SensorModelFactory, SensorModelTypes
        from aws.osml.model_runner.photogrammetry.coordinates import GeodeticWorldCoordinate, ImageCoordinate
        from aws.osml.model_runner.photogrammetry.replacement_sensor_model import RSMPolynomialSensorModel
