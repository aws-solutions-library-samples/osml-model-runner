...
class GDALAffineSensorModelBuilder(SensorModelBuilder):
    ...
    def __init__(self, geo_transform: List[float]) -> None:
        ...
        :param geo_transform: List[float] = the geotransform for this image
    ...
    def build(self) -> Optional[GDALAffineSensorModel]:
        ...
        :return: Optional[GDALAffineSensorModel] = affine transform based SensorModel that uses the GDAL GeoTransform
        """
...
class GDALGCPSensorModelBuilder(SensorModelBuilder):
    ...
    def __init__(self, ground_control_points: List[gdal.GCP]) -> None:
        ...
        :param ground_control_points: List[gdal.GCP] = the ground control points for this image
    ...
    def build(self) -> Optional[ProjectiveSensorModel]:
        ...
        :return: Optional[ProjectiveSensorModel] = a projective transform SensorModel that uses the GDAL GCPs provided
        """
