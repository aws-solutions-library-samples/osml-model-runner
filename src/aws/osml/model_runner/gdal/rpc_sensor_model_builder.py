...
from aws.osml.model_runner.photogrammetry import RPCPolynomial, RPCSensorModel
...
class RPCSensorModelBuilder(SensorModelBuilder):
    ...
    def build(self) -> Optional[RPCSensorModel]:
        ...
        :return: Optional[RPCSensorModel] = a RPC SensorModel if one can be constructed, None otherwise
        """
    ...
    def build_rpc_sensor_model(rpc_tre: ElementTree.Element) -> RPCSensorModel:
        ...
        :param rpc_tre: ElementTree.Element = the GDAL XML for RPC00B

        :return: RPCSensorModel = the RPC sensor model
        """
    ...
    def build_rpc_polynomial(rpc_tre: ElementTree.Element, polynomial_name: str) -> RPCPolynomial:
        ...
        :param rpc_tre: ElementTree.Element = the GDAL XML for RPC00B
        :param polynomial_name: str = the name of the polynomial to build

        :return: RPCPolynomial = the RPC polynomial
        """
