...
from aws.osml.model_runner.photogrammetry import ChippedImageSensorModel, CompositeSensorModel, ImageCoordinate, SensorModel
...
class ChippedImageInfoFacade:
    ...
    def __init__(self, ichipb_tre: ElementTree.Element) -> None:
        ...
        :param ichipb_tre: ElementTree.Element = the GDAL XML for the ICHIPB TRE
...
class SensorModelFactory:
    ...
    def __init__(
        ...
        :param actual_image_width: int = width of the current image
        :param actual_image_height: int = height of the current image
        :param xml_tres: Optional[ElementTree.Element] = XML representing metadata in the tagged record extensions(TRE)
        :param geo_transform: Optional[List[float]] = a GDAL affine transform
        :param ground_control_points: Optional[List[gdal.GCP]] = a list of GDAL GCPs that identify correspondences in
                                      the image
        :param selected_sensor_model_types: Optional[List[SensorModelTypes]] = a list of sensor models that should be
                                            attempted by this factory
    ...
    def build(self) -> Optional[SensorModel]:
        ...
        :return: Optional[SensorModel] = the highest quality sensor model available given the information provided
        """
