...
from aws.osml.model_runner.photogrammetry import DigitalElevationModelTileFactory, GDALAffineSensorModel
...
class GDALDigitalElevationModelTileFactory(DigitalElevationModelTileFactory):
    ...
    def __init__(self, tile_directory: str) -> None:
        ...
        :param tile_directory: str = the root tile location, may be an S3 URL
    ...
    def get_tile(self, tile_path: str) -> Tuple[Optional[Any], Optional[GDALAffineSensorModel]]:
        ...
        :return: Tuple[Optional[Any], Optional[GDALAffineSensorModel]] = an array of elevation values
                                                            and a sensor model or (None, None)
        """
