...
from aws.osml.model_runner.photogrammetry import GeodeticWorldCoordinate, ImageCoordinate, ProjectiveSensorModel
...
class ProjectiveSensorModelBuilder(SensorModelBuilder):
    ...
    def __init__(self, xml_tres: ElementTree.Element, full_image_width: float, full_image_height: float) -> None:
        ...
        :param full_image_width: float = the width of the image in pixels
        :param full_image_height: float = the height of the image in pixels
    ...
    def build(self) -> Optional[ProjectiveSensorModel]:
        ...
        :return: Optional[ProjectiveSensorModel] = a ProjectiveSensorModel if one can be constructed, None otherwise
        """
    ...
    def build_projective_sensor_model(
        ...
        :param cscrna_tre: ElementTree.Element = the GDAL XML for CSCRNA
        :param full_image_width: float = the width of the image in pixels
        :param full_image_height: float = the height of the image in pixels

        :return: ProjectiveSensorModel = the projective sensor model
        """
