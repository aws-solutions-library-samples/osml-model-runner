...
class GDALConfigEnv:
    ...
    def with_aws_credentials(self, aws_credentials: Optional[Dict[str, str]]) -> "GDALConfigEnv":
        ...
        :param aws_credentials: Optional[Dict[str, str]] = the dictionary of values from the sts.assume_role()
                                response['Credentials']
        :return: GDALConfigEnv = self to facilitate a simple builder constructor pattern
        """
