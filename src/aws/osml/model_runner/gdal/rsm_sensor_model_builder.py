...
class RSMSensorModelBuilder(SensorModelBuilder):
    ...
    def __init__(self, xml_tres: ElementTree.Element) -> None:
        ...
        :param xml_tres: ElementTree.Element = the XML tres for this image
    ...
    def build(self) -> Optional[RSMPolynomialSensorModel]:
        """
        Examine the TRE metadata for RSM information, parse the necessary values out of those TREs, and construct a
        RSM sensor model.

        :return: Optional[RSMPolynomialSensorModel] = a RSM Polynomial SensorModel if one can be constructed, None otherwise
        """
    ...
    def _build_rsm_ground_domain(rsmid_tre: ElementTree.Element) -> RSMGroundDomain:
        ...
        :param rsmid_tre: ElementTree.Element = the GDAL XML for RSMIDA

        :return: RSMGroundDomain = the ground domain
        """
    ...
    def _build_rsm_image_domain(rsmid_tre: ElementTree.Element) -> RSMImageDomain:
        ...
        :param rsmid_tre: ElementTree.Element = the GDAL XML for RSMIDA
        :return: RSMImageDomain = the image domain
        """
    ...
    def _build_rsm_context(rsmid_tre: ElementTree.Element) -> RSMContext:
        ...
        :return: RSMContext = the RSM context
        """
        return RSMContext(
    ...
    def _build_rsm_polynomial(rsmpc_tre: ElementTree.Element, polynomial_prefix: str) -> RSMPolynomial:
        ...
        :param rsmpc_tre: ElementTree.Element = the GDAL XML for RSMPCA
        :param polynomial_prefix: str = the prefix identifying the polynomial
    ...
    def _build_rsm_polynomial_sensor_model(
        ...
        :param rsmpc_tre: ElementTree.Element = the GDAL XML for RSMPCA
        :param rsm_context: RSMContext = the corresponding RSM context

        :return: RSMPolynomialSensorModel = the RSM polynomial sensor model
        """
