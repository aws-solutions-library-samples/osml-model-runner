...
def nms_method(boxes, scores, labels, method: int = 3, iou_thr: float = 0.5, sigma: float = 0.5, thresh: float = 0.001, weights: Optional[List[float]] = None) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def nms(boxes: List[np.ndarray], scores: List[np.ndarray], labels: List[np.ndarray], iou_thr: float = 0.5, weights: Optional[List[float]] = None) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def soft_nms(boxes: List[np.ndarray], scores: List[np.ndarray], labels: List[np.ndarray], method: int = 2, iou_thr: float = 0.5, sigma: float = 0.5, thresh: float = 0.001, weights: Optional[List[float]] = None) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
