...
class Timer(object):
    ...
    def __enter__(self):
        self.logger.info("Starting: {}".format(self.str))
    ...
    def __exit__(self, exc_type: str, exc_val: str, exec_traceback: str) -> None:
        ...
        try:
            if self.metrics_logger:
                ...
                self.logger.info("{} took {} {}.".format(self.str, str(total_time), time_unit.lower()))
                if self.normalizing_factor and self.normalizing_unit:
                    ...
                    self.logger.info(
                        "{} took {} {} per {}.".format(
                            self.str, str(time_per_unit), time_unit.lower(), self.normalizing_unit
                        )
                    )
        except Exception as err:
            self.logger.warning("Unable to log metrics: {}".format(str(err)))
