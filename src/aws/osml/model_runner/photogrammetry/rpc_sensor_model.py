...
class RPCPolynomial:
    def __init__(self, coefficients: List[float]) -> None:
        ...
        :param coefficients: List[float] = coefficients
...
class RPCSensorModel(SensorModel):
    ...
    def __init__(
        ...
        :param err_bias: float = non time-varying error estimate assumes correlated images
        :param err_rand: float = time-varying error estimate assumes uncorrelated images
        :param line_off: float = offset used to normalize/denormalize image y components
        :param samp_off: float = offset used to normalize/denormalize image x components
        :param lat_off: float = offset used to normalize/denormalize world y components
        :param long_off: float = offset used to normalize/denormalize world x components
        :param height_off: float = offset used to normalize/denormalize world z components
        :param line_scale: float = scale used to normalize/denormalize image y components
        :param samp_scale: float = scale used to normalize/denormalize image x components
        :param lat_scale: float = scale used to normalize/denormalize world y components
        :param long_scale: float = scale used to normalize/denormalize world x components
        :param height_scale: float = scale used to normalize/denormalize world z components
        :param line_num_poly: RPCPolynomial = polynomial used as the numerator in line (row) calculations
        :param line_den_poly: RPCPolynomial = polynomial used as the denominator in line (row) calculations
        :param samp_num_poly: RPCPolynomial = polynomial used as the numerator in sample (column) calculations
        :param samp_den_poly: RPCPolynomial = polynomial used as the denominator in sample (column) calculations
    ...
    def image_to_world(
        ...
        :param elevation_model: Optional[ElevationModel] = an optional elevation model used to transform the coordinate
