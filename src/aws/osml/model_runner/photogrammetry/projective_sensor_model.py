...
class ProjectiveSensorModel(SensorModel):
    ...
    def __init__(
        ...
        :param world_coordinates: List[GeodeticWorldCoordinate] = a list of world points
        :param image_coordinates: List[ImageCoordinate] = the corresponding list of locations in the image
    ...
    def image_to_world(
        ...
        :param image_coordinate: ImageCoordinate = the x, y image coordinate
        :param elevation_model: Optional[ElevationModel] = optional elevation model used to transform the coordinate
        :param options: Optional[Dict[str, Any]] = optional dictionary of hints, this camera does not support any hints
    ...
    def world_to_image(self, world_coordinate: GeodeticWorldCoordinate) -> ImageCoordinate:
        ...
        :param world_coordinate: GeodeticWorldCoordinate = the longitude, latitude, elevation world coordinate

        :return: ImageCoordinate = the x, y image coordinate
        """
