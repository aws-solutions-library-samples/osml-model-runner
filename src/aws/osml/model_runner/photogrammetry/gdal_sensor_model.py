...
class GDALAffineSensorModel(SensorModel):
    ...
    def __init__(self, geo_transform: List) -> None:
        ...
        :param geo_transform: List = the 6 coefficients of the affine transform
    ...
    def image_to_world(
        ...
        :param options: Optional[Dict[str, Any]] = an optional dictionary of hints, does not support any hints
