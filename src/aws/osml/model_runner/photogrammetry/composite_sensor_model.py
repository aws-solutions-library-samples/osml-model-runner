...
class CompositeSensorModel(SensorModel):
    ...
    def __init__(self, approximate_sensor_model: SensorModel, precision_sensor_model: SensorModel) -> None:
        ...
        :param approximate_sensor_model: SensorModel = a faster but less accurate model
        :param precision_sensor_model: SensorModel = a slower but more accurate model
    ...
    def image_to_world(
        ...
        :param options: Optional[Dict[str, Any]] = the options that will be augmented and then passed along
