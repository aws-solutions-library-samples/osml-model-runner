...
class ProjectiveTransform:
    ...
    def __init__(self, matrix_parameters: npt.ArrayLike) -> None:
        ...
        :param matrix_parameters: npt.ArrayLike = the matrix parameters for this transformation
    ...
    def forward(self, src_coords: npt.ArrayLike):
        ...
        :param src_coords: npt.ArrayLike = the source coordinates
    ...
    def inverse(self, dst_coords: npt.ArrayLike):
        ...
        :param dst_coords: npt.ArrayLike = the destination coordinates
    ...
    def estimate(cls, src: npt.ArrayLike, dst: npt.ArrayLike) -> ProjectiveTransform:
        ...
        :param src: npt.ArrayLike = the source points
        :param dst: npt.ArrayLike = the destination points

        :return: ProjectiveTransform = the projective transform
        """
        xs = src[:, 0]
        ys = src[:, 1]
