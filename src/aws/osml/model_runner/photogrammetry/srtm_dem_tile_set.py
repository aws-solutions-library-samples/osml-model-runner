...
class SRTMTileSet(DigitalElevationModelTileSet):
    ...
    def __init__(self, prefix: str = "", version: str = "1arc_v3", format_extension: str = ".tif") -> None:
        ...
        :param prefix: str = an optional prefix (possibly a subdirectory) for the tile set
        :param version: str = the version (e.g. 1arc_v3 or 3arc_v2)
        :param format_extension: str = the image extension (e.g. .tif)
    ...
    def find_tile_id(self, geodetic_world_coordinate: GeodeticWorldCoordinate) -> Optional[str]:
        """
        This method creates tile IDs that match the file names for grid tiles downloaded using the USGS Earth Explorer.
