...
class DigitalElevationModelTileSet(ABC):
    ...
    def find_tile_id(self, geodetic_world_coordinate: GeodeticWorldCoordinate) -> Optional[str]:
        ...
        :return: Optional[str] = the tile path or None if the DEM does not have coverage for this location
        """
...
class DigitalElevationModelTileFactory(ABC):
    ...
    def get_tile(self, tile_path: str) -> Tuple[Optional[Any], Optional[SensorModel]]:
        ...
        :param tile_path: str = the location of the tile to load

        :return: Tuple[Optional[Any], Optional[SensorModel]] = an array of elevation values and a sensor model
        """
...
class DigitalElevationModel(ElevationModel):
    ...
    def set_elevation(self, geodetic_world_coordinate: GeodeticWorldCoordinate) -> None:
        ...
        :param geodetic_world_coordinate: GeodeticWorldCoordinate = the coordinate to update
    ...
    def get_interpolation_grid(self, tile_path: str) -> Tuple[Optional[interp2d], Optional[SensorModel]]:
        ...
        :return: Tuple[Optional[interp2d], Optional[SensorModel]] = the cached interpolation object and sensor model
        """
