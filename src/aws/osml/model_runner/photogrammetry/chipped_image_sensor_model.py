...
class ChippedImageSensorModel(SensorModel):
    ...
    def __init__(
        ...
        :param original_image_coordinates: List[ImageCoordinate] = locations in image related to chipped image bounds
        :param chipped_image_coordinates: List[ImageCoordinate] = bounds of the chipped image
        :param full_image_sensor_model: SensorModel = the sensor model for the full image
    ...
    def image_to_world(
        ...
        :param elevation_model: Optional[ElevationModel] = an elevation model used to transform the coordinate
